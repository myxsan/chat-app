...
const FriendRequestsSidebarOptions: FC<FriendRequestsSidebarOptionsProps> = ({
  ...
  useEffect(() => {
    ...
    pusherClient.bind("incoming_friend_requests", requestHandler);
  ...
  return (
    <Link
      ...
      className="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex items-center p-2 gap-x-3 rounded-md text-sm leading-6 font-semibold"
    >
